...
<head>
    ...
    <title>SPK Penetuan Jurusan</title>
        ...
        <nav class="main-header navbar navbar-expand-md navbar-dark navbar-primary">
            <div class="container">
                ...
                <div class="collapse navbar-collapse order-5" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a href="<?= site_url('controllerHome') ?>" class="nav-link">Beranda</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container">
                    <div class="row mb-1">
                        <div class="col-sm-7">
                            <h1 class="m-2 text-dark">Aplikasi Penentuan Jurusan SMK Negeri 3 Palu</h1>
                        </div><!-- /.col -->
