...
<body class="hold-transition login-page" style="background-image: url('<?= site_url() ?>/assets/5853.jpg'); background-position: center;
  background-repeat: no-repeat;
  background-size: cover;">
    <div class="login-box">
        <div class="login-logo">
            <a href="#" style="color: gray-dark;"><b>SPK Penentuan Jurusan</b> </a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">SMK 3 Palu</p>
